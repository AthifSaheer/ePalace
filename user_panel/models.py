...
class Product(models.Model):
    ...
    more_image_one = models.ImageField(upload_to='prd_imgs', null=True, blank=True)
    more_image_two = models.ImageField(upload_to='prd_imgs', null=True, blank=True)
    more_image_three = models.ImageField(upload_to='prd_imgs', null=True, blank=True)
